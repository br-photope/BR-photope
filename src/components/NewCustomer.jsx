...
export default function NewCustomer() {
  ...
  const handleClickAdd = () => {
    ...
    //updating total collection
    console.log(importedCustomersDataContext.totalCollection);
    importedCustomersDataContext.setTotalCollection(importedCustomersDataContext.totalCollection + Number(cprice))
    console.log(importedCustomersDataContext.totalCollection)

    
    //adding new customers data to customersData
    ...
    //updating countArr
    let newCountArr = importedCustomersDataContext.countArr;
    newCountArr[3] = newCountArr[3] +1;
    importedCustomersDataContext.setCountArr(newCountArr);
