...
function App() {
  ...
  //table contents
  const [tableContents, setTableContents] = useState( ["New Customers","New Order","Shoot Done","Selection Done","Editing Done","Out for print","Ready for pickup","Delivered","Delay Orders","Pending Payments","All Customers"] );
  ...
  return (
    <>
      <CustomersDataContext.Provider value={ {customersData, setCustomersData, countArr, setCountArr, phaseArr, setPhaseArr, totalCollection, setTotalCollection, tableContents, setTableContents} }>
